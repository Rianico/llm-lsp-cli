...
"""Type stubs for python-daemon.

Signal handlers use Any return type per typeshed conventions.
This file is part of the typings designated zone (typings/**/*.pyi).
"""
...
import signal
from .pidfile import PIDLockFile
...
class DaemonContext:
    ...
    def __init__(
        ...
        initgroups: bool = ...,
        prevent_core: bool = ...,
        detach_process: bool | None = ...,
        files_preserve: Sequence[int | IO[str]] | None = ...,
        pidfile: PIDLockFile | None = ...,
        stdin: IO[str] | None = ...,
        stdout: IO[str] | None = ...,
        stderr: IO[str] | None = ...,
        signal_map: dict[int | signal.Signals, Callable[[int, FrameType | None], Any] | str | None] | None = ...,
    ) -> None:
    ...
    def terminate(self, signal_number: int, stack_frame: FrameType | None) -> None:
...
def change_working_directory(directory: str) -> None:
...
def change_root_directory(directory: str) -> None:
...
def change_file_creation_mask(mask: int) -> None:
...
def change_process_owner(uid: int, gid: int, initgroups: bool = ...) -> None:
...
def is_socket_file(file: IO[str]) -> bool:
...
_total_file_descriptor_range: range
def close_all_open_files(exclude: set[int] = ...) -> None:
...
def make_default_signal_map() -> dict[signal.Signals, str | None]:
...
def set_signal_handlers(signal_handler_map: dict[int | signal.Signals, Callable[[int, FrameType | None], Any] | str | None]) -> None:
...
def register_atexit_function(func: Callable[[], None]) -> None:
